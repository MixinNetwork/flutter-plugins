...
class TableCellRange {
  ...
  final TableCellPosition start;
  final TableCellPosition end;
  ...
  bool operator ==(Object other) {
    ...
    return other is TableCellRange && other.start == start && other.end == end;
  }
...
class TableCellSelection {
  ...
  final int blockIndex;
  final TableCellPosition base;
  final TableCellPosition extent;

  TableCellRange get normalizedRange {
    final startRow =
        base.rowIndex <= extent.rowIndex ? base.rowIndex : extent.rowIndex;
    final endRow =
        base.rowIndex <= extent.rowIndex ? extent.rowIndex : base.rowIndex;
    final startColumn = base.columnIndex <= extent.columnIndex
        ? base.columnIndex
        : extent.columnIndex;
    final endColumn = base.columnIndex <= extent.columnIndex
        ? extent.columnIndex
        : base.columnIndex;
  ...
  bool operator ==(Object other) {
    ...
    return other is TableCellSelection &&
        other.blockIndex == blockIndex &&
        other.base == base &&
        other.extent == extent;
  }
  ...
  @override
  int get hashCode => Object.hash(blockIndex, base, extent);
}
