...
Future<void> main(List<String> args) async {
  ...
  await WindowPlus.ensureInitialized(
    application: 'one.mixin.desktop_multi_window_example',
...
class _WindowChrome extends StatelessWidget {
  const _WindowChrome({Key? key, required this.child}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        child,
        WindowCaption(brightness: Brightness.dark),
      ],
    );
  }
}

class _ExampleMainWindow extends StatelessWidget {
