...
static void desktop_multi_window_plugin_handle_method_call(
  ...
  if (g_str_has_prefix(method, "window_")) {
    ...
    auto window_id = MultiWindowManager::Instance()->Create(arguments);
    ...
    fl_value_set_string_take(definition, "windowId", fl_value_new_string(window_id.c_str()));
    fl_value_set_string_take(definition, "windowArgument", fl_value_new_string(window_argument.c_str()));
